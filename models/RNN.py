...
"""
RNN model, creates an n-layer RNN with a final fully connected layer
"""
...
class RNN(nn.Module):
    def __init__(self, params):
        ...
        self.rnn = nn.RNN(input_size=params["input_dim"], hidden_size=params["hidden_size"], num_layers=params["layers"], dropout=params["drop_prob"], batch_first=True)
