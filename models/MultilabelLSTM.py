...
class LSTM(nn.Module):
    """
    n-layered LSTM model with a single fully connected layer on
    the last output of the sequence
    (many-to-one)
    LogSoftMax is used in the last layer of multilabel experiments as the
    used loss function in these experiments (KLDivLoss) requires the output to
    contain log-probabilities
    """
