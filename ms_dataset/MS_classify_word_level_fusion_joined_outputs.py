...
joined_model_params["input_dim"] = acoustic_params["label_dim"] + embeddings_params["label_dim"]
...
train_two_modality_rnn_join_outputs(embeddings_resources, acoustic_resources, id_to_name, experiment_dir, joined_model, logger, joined_model_params)
