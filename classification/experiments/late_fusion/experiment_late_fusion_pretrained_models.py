...
word_embedding_params["embedding_dim"] = word_embedding_dataset_train.tensors[0][0].size()[1]
...
emobase_params["embedding_dim"] = emobase_dataset_train.tensors[0][0].size()[1]
...
joined_model_params["embedding_dim"] = emobase_params["hidden_size"] + word_embedding_params["hidden_size"]
