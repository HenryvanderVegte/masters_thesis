...
ALL_WORDS = "C://Users//Henry//Desktop//IEMOCAP_txt//experiments//Naive Bayes//all_words.txt"
PICKLE = "C://Users//Henry//Desktop//IEMOCAP_txt//experiments//Naive Bayes//naive_bayes.pickle"
...
def get_train_data(lines, all_words):
    ...
    for line in lines:
        ...
        utterance = line.split('\t')[2]
        tokens = nltk.word_tokenize(utterance.lower())
        train_instance = ({word: (word in tokens) for word in all_words}, label)
