...
result_feature_file = os.path.join(ROOT_FOLDER, 'datasets//IEMOCAP//features//audio//emobase_word_level_with_pauses_top_50.npy')
...
exlude_features = feature_ranking[50:]
